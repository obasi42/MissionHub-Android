...
/**
 * Entity mapped to table PERSON (schema version 1).
 */
public class Person {
    ...
    private java.util.Date first_contact_date;
    private java.util.Date date_surveyed;
    ...
    private Integer num_contacts;
    private java.util.Date retrieved;
    ...
    public Person(int _id, String name, String gender, String fb_id, String picture, String status, java.util.Date first_contact_date, java.util.Date date_surveyed, String first_name, String last_name, String phone_number, String email_address, String birthday, String locale, Integer num_contacts, java.util.Date retrieved) {
        this._id = _id;
        this.name = name;
        this.gender = gender;
        this.fb_id = fb_id;
    ...
    public java.util.Date getFirst_contact_date() {
        return first_contact_date;
    }

    public void setFirst_contact_date(java.util.Date first_contact_date) {
        this.first_contact_date = first_contact_date;
    }

    public java.util.Date getDate_surveyed() {
        return date_surveyed;
    }

    public void setDate_surveyed(java.util.Date date_surveyed) {
        this.date_surveyed = date_surveyed;
    }
    ...
    public void setRetrieved(java.util.Date retrieved) {
        this.retrieved = retrieved;
    }
