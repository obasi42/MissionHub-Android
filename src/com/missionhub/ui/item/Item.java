...
/**
 * Base class for all items used in GreenDroid. An item represents a wrapper of data. Each item contains at least all
 * the information needed to display a single row in a ListView.
 * 
...
public abstract class Item {
	 ...
	 * @return The tag associated to the key <em>key</em> or null if no tags are associated to that key
	 */
	...
	/**
	 * Return a view that is associated to the current item. The returned view is normally capable of being a good
	 * recipient for all item's information.
	 * 
	 * @param context
	 *            The Context in which the {@link ItemView} will be used
	 * @param parent
	 *            The parent View of that new View. The parent is usually the parent ListView and may be used to
	 *            retrieve the correct LayoutParams type.
	 ...
	 */
	protected static ItemView createCellFromXml(final Context context, final int layoutID, final ViewGroup parent) {
