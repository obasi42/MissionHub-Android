...
public class GroupLabel {
    ...
    public GroupLabel(Long id) {
        this.id = id;
    }

    public GroupLabel(Long id, String name, Long organization_id, String ancestry, java.util.Date created_at, java.util.Date updated_at, Integer group_labelings_count) {
        this.id = id;
        this.name = name;
    ...
    public void setGroup_labelings_count(Integer group_labelings_count) {
        this.group_labelings_count = group_labelings_count;
    }
