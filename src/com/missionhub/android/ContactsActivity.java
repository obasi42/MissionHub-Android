...
import com.missionhub.android.api.old.ContactsApi;
import com.missionhub.android.api.old.convert.PersonJsonSql;
import com.missionhub.android.api.old.model.GMetaPeople;
import com.missionhub.android.api.old.model.GPerson;
...
import com.missionhub.android.fragment.ContactListFragment;
import com.missionhub.android.fragment.NavigationMenuFragment;
import com.missionhub.android.fragment.ContactListFragment.OnContactListListener;
import com.missionhub.android.fragment.NavigationMenuFragment.NavigationMenuFragmentInterface;
import com.missionhub.android.ui.NavigationMenu;
import com.missionhub.android.ui.DynamicLayoutAdapter.DynamicLayoutInterface;
...
/**
 * The activity used to display a list of contacts. (My Contacts, All Contacts, Directory)
 */
public class ContactsActivity extends MissionHubMainActivity implements OnContactListListener, NavigationMenuFragmentInterface, DynamicLayoutInterface {
...
//		}
	...
	private final class AnActionModeOfEpicProportions implements ActionMode.Callback {
		...
		public boolean onActionItemClicked(final ActionMode mode, final MenuItem item) {
			Toast.makeText(ContactsActivity.this, "Got click: " + item, Toast.LENGTH_SHORT).show();
			mode.finish();
			mMode = null;
			return true;
		}
