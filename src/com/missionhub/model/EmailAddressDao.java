...
public class EmailAddressDao extends AbstractDao<EmailAddress, Long> {
    ...
    */
    ...
    public synchronized List<EmailAddress> _queryPerson_EmailAddressList(Long person_id) {
        if (person_EmailAddressListQuery == null) {
            ...
            person_EmailAddressListQuery.setParameter(0, person_id);
        }
        return person_EmailAddressListQuery.list();
    }
