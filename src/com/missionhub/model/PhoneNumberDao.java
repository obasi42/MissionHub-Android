...
public class PhoneNumberDao extends AbstractDao<PhoneNumber, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Email_updated_at = new Property(5, java.util.Date.class, "email_updated_at", false, "EMAIL_UPDATED_AT");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PHONE_NUMBER' (" + //
                ...
                "'EMAIL_UPDATED_AT' INTEGER," + // 5: email_updated_at
    ...
    protected void bindValues(SQLiteStatement stmt, PhoneNumber entity) {
        ...
        java.util.Date email_updated_at = entity.getEmail_updated_at();
        if (email_updated_at != null) {
            stmt.bindLong(6, email_updated_at.getTime());
        }
    ...
    public PhoneNumber readEntity(Cursor cursor, int offset) {
        PhoneNumber entity = new PhoneNumber( //
            ...
            cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)), // email_updated_at
    ...
    public void readEntity(Cursor cursor, PhoneNumber entity, int offset) {
        ...
        entity.setEmail_updated_at(cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)));
    ...
    public synchronized List<PhoneNumber> _queryPerson_PhoneNumberList(Long person_id) {
        if (person_PhoneNumberListQuery == null) {
            ...
            person_PhoneNumberListQuery.setParameter(0, person_id);
        }
        return person_PhoneNumberListQuery.list();
    }
