...
public class SurveyDao extends AbstractDao<Survey, Long> {
    ...
    */
    ...
    public synchronized List<Survey> _queryOrganization_Surveys(Long organization_id) {
        if (organization_SurveysQuery == null) {
            ...
            organization_SurveysQuery.setParameter(0, organization_id);
        }
        return organization_SurveysQuery.list();
    }
