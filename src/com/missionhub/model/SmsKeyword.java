...
public class SmsKeyword {
    ...
    public SmsKeyword(Long id, String keyword, Long organization_id, Long user_id, String explanation, String state, String initial_response, Long survey_id, java.util.Date updated_at, java.util.Date created_at) {
        this.id = id;
    ...
    public Survey getSurvey() {
        if (survey__resolvedKey == null || !survey__resolvedKey.equals(survey_id)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            SurveyDao targetDao = daoSession.getSurveyDao();
            survey = targetDao.load(survey_id);
