...
public class GroupLabels {
	...
	private transient GroupLabelsDao myDao;
	...
	public GroupLabels(final Long id) {
		this.id = id;
	}

	public GroupLabels(final Long id, final Long group_id, final Long label_id) {
		this.id = id;
	...
	public GroupLabel getGroupLabel() {
		if (groupLabel__resolvedKey == null || !groupLabel__resolvedKey.equals(label_id)) {
			...
			final GroupLabelDao targetDao = daoSession.getGroupLabelDao();
	...
	public void setGroupLabel(final GroupLabel groupLabel) {
