...
public class GroupDao extends AbstractDao<Group, Long> {
    ...
    */
    ...
    public synchronized List<Group> _queryOrganization_GroupList(Long organization_id) {
        if (organization_GroupListQuery == null) {
            ...
            organization_GroupListQuery.setParameter(0, organization_id);
        }
        return organization_GroupListQuery.list();
    }
