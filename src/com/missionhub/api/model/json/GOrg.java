...
public class GOrg {
	...
	public GOrgGeneric[] getOrganization_membership() {
		return organization_membership;
	}

	public void setOrganizational_roles(GOrgGeneric[] x) {
		organizational_roles = x;
	}

	public void setOrganization_membership(GOrgGeneric[] x) {
		organization_membership = x;
	}
}
