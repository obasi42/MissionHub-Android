...
public class GPerson {
	...
	public void setRequest_org_id(String s) {
		request_org_id = s;
	}

	public void setPhone_number(String s) {
		phone_number = s;
	}

	public void setEmail_address(String s) {
		email_address = s;
	}
	...
	public void setLocation(GIdNameProvider x) {
		location = x;
	}

	public void setInterests(GIdNameProvider[] i) {
		interests = i;
	}

	public void setAssignment(GAssign a) {
		assignment = a;
	}

	public void setOrganizational_roles(GOrgGeneric[] g) {
		organizational_roles = g;
	}

	public void setEducation(GEducation[] g) {
		education = g;
	}
