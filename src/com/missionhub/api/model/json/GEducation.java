...
public class GEducation {
	...
	public void setSchool(GIdNameProvider g) {
		school = g;
	}

	public void setYear(GIdNameProvider g) {
		year = g;
	}
	...
	public void setConcentration(GIdNameProvider[] g) {
		concentration = g;
	}

	public void setDegree(GIdNameProvider g) {
		degree = g;
	}
}
