...
public class GroupDao extends AbstractDao<Group, Long> {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        String sql = "CREATE TABLE " + (ifNotExists? "IF NOT EXISTS ": "") + "'GROUP' (" + //
    ...
    protected void bindValues(SQLiteStatement stmt, Group entity) {
        ...
        java.util.Date group = entity.getGroup();
        if (group != null) {
    ...
    public synchronized List<Group> _queryOrganization_Groups(Long organization_id) {
