...
public class Label {
    ...
    public Label(Long id, String name, Long organization_id, String ancestry, java.util.Date created_at, java.util.Date updated_at, Integer group_labelings_count) {
        this.id = id;
        this.name = name;
