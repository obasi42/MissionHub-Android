...
public class Label {
	...
	public Label(final Long id, final String name, final Long organization_id, final String ancestry, final java.util.Date created_at, final java.util.Date updated_at,
