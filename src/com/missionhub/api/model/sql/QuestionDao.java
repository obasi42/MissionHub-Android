...
public class QuestionDao extends AbstractDao<Question, Long> {
	...
	public static void createTable(final SQLiteDatabase db, final boolean ifNotExists) {
		final String sql = "CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "'QUESTION' (" + //
	...
	/**
	 * Internal query to resolve the "questions" to-many relationship of
	 * Keyword.
	 */
	...
	/**
	 * Internal query to resolve the "questionList" to-many relationship of
	 * Question.
	 */
	public synchronized List<Question> _queryQuestion_QuestionList(final Long question_id) {
