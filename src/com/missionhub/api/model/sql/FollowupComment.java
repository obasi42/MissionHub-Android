...
public class FollowupComment {
	...
	public FollowupComment(final Long id) {
		this.id = id;
	}

	public FollowupComment(final Long id, final Long contact_id, final Long commenter_id, final Long organization_id, final String comment, final String status,
			final java.util.Date created_at, final java.util.Date updated_at, final java.util.Date deleted_at) {
		this.id = id;
	...
	public void setContact_id(final Long contact_id) {
		this.contact_id = contact_id;
	}
	...
	public void setCommenter_id(final Long commenter_id) {
		this.commenter_id = commenter_id;
	}
	...
	public void setDeleted_at(final java.util.Date deleted_at) {
		this.deleted_at = deleted_at;
	}
	...
	public synchronized List<Rejoicable> getRejoicables() {
		if (rejoicables == null) {
			...
			final RejoicableDao targetDao = daoSession.getRejoicableDao();
