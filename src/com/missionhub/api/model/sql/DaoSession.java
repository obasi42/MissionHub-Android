...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        contactListCacheDaoConfig = daoConfigMap.get(ContactListCacheDao.class).clone();
        contactListCacheDaoConfig.initIdentityScope(type);
    ...
    public ContactListCacheDao getContactListCacheDao() {
        return contactListCacheDao;
    }
