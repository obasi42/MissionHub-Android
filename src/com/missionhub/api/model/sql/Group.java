...
public class Group {
    ...
    public Group(Long id, String name, String location, String meets, Integer start_time, Integer end_time, Long organization_id, java.util.Date group, java.util.Date updated_at, Boolean list_publicly, Boolean approve_join_requests) {
        this.id = id;
        this.name = name;
    ...
    public void setGroup(java.util.Date group) {
        this.group = group;
    }
