...
public class Group {
	...
	public Group(final Long id, final String name, final String location, final String meets, final Integer start_time, final Integer end_time, final Long organization_id,
			final java.util.Date group, final java.util.Date updated_at, final Boolean list_publicly, final Boolean approve_join_requests) {
		this.id = id;
		this.name = name;
	...
	public void setStart_time(final Integer start_time) {
		this.start_time = start_time;
	}
	...
	public void setEnd_time(final Integer end_time) {
		this.end_time = end_time;
	}
	...
	public java.util.Date getGroup() {
		return group;
	}

	public void setGroup(final java.util.Date group) {
		this.group = group;
	}
	...
	public synchronized List<Label> getLabels() {
		if (labels == null) {
			...
			final LabelDao targetDao = daoSession.getLabelDao();
			labels = targetDao._queryGroup_Labels(id);
		}
		return labels;
	}
