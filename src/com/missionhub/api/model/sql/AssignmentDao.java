...
public class AssignmentDao extends AbstractDao<Assignment, Long> {
	...
	public static void createTable(final SQLiteDatabase db, final boolean ifNotExists) {
		final String sql = "CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "'ASSIGNMENT' (" + //
	...
	/**
	 * Internal query to resolve the "assigned_contacts" to-many relationship of
	 * Person.
	 */
	...
	/**
	 * Internal query to resolve the "assigned_to_contacts" to-many relationship
	 * of Person.
	 */
