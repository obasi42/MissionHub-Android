...
public class InterestDao extends AbstractDao<Interest, Long> {
	...
	public InterestDao(final DaoConfig config) {
		super(config);
	}

	public InterestDao(final DaoConfig config, final DaoSession daoSession) {
		super(config, daoSession);
	}

	/** Creates the underlying database table. */
	public static void createTable(final SQLiteDatabase db, final boolean ifNotExists) {
		final String sql = "CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "'INTEREST' (" + //
	...
	public static void dropTable(final SQLiteDatabase db, final boolean ifExists) {
		final String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'INTEREST'";
		db.execSQL(sql);
	}

	/** @inheritdoc */
	@Override
	protected void bindValues(final SQLiteStatement stmt, final Interest entity) {
		stmt.clearBindings();
		...
		final String interest_id = entity.getInterest_id();
		if (interest_id != null) {
	...
	/** @inheritdoc */
	@Override
	public Interest readEntity(final Cursor cursor, final int offset) {
		final Interest entity = new Interest( //
	...
	/** @inheritdoc */
	@Override
	public void readEntity(final Cursor cursor, final Interest entity, final int offset) {
	...
	@Override
	protected Long updateKeyAfterInsert(final Interest entity, final long rowId) {
		entity.setId(rowId);
		return rowId;
	}
	...
	/** @inheritdoc */
	@Override
	public Long getKey(final Interest entity) {
		if (entity != null) {
			return entity.getId();
		} else {
			return null;
	...
	/**
	 * Internal query to resolve the "interestList" to-many relationship of
	 * Person.
	 */
	public synchronized List<Interest> _queryPerson_InterestList(final Long person_id) {
		if (person_InterestListQuery == null) {
			final QueryBuilder<Interest> queryBuilder = queryBuilder();
