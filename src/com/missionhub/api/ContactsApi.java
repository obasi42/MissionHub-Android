...
public class ContactsApi {
	 ...
	 * @return
	 */
	public static ApiRequest create(final Context context, final GPerson person, final boolean assignToMe, final ApiHandler apiHandler) {
	...
	private static void addPersonToParams(final HttpParams params, final GPerson person) {
		maybeAddToParams(params, "person[firstName]", person.getFirst_name());
		maybeAddToParams(params, "person[lastName]", person.getLast_name());
		maybeAddToParams(params, "person[email_address][email]", person.getEmail_address());
		maybeAddToParams(params, "person[phone_number][number]", person.getPhone_number());
		maybeAddToParams(params, "person[gender]", person.getGender());
	}

	private static void maybeAddToParams(final HttpParams params, final String key, final Object value) {
	 ...
	 * @return
	 */
	public static ApiRequest list(final Context context, final ContactsApi.Options options, final ApiHandler apiHandler) {
		final ApiClient client = new ApiClient();
		final String url = ApiHelper.getAbsoluteUrl("contacts");
		final HttpHeaders headers = ApiHelper.getDefaultHeaders(context);
		final HttpParams params = ApiHelper.getDefaultParams(context);
