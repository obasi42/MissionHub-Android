...
public class PersonJsonSql {
	...
	public static void update(final Context context, final GPerson person, final String tag) {
		if (person == null)
			return;
	...
	public static void update(Context context, GMetaContact contact, String tag) {
		if (contact == null)
			return;
