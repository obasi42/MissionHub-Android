 ...
 * To add an upgrade:
 * 
 * 1.) add the version number to versions. 2.) created a method from the
 * previous version to the new version in the format
 * v{oldMajor_oldMinor}to{newMajor_newMinor}
 */
