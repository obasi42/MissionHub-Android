...
public class Organization implements com.missionhub.model.TimestampedEntity {
    ...
    public List<Survey> getSortedSurveys() {
        if (mSortedSurveys == null) {
            ...
            SurveyDao targetDao = daoSession.getSurveyDao();
            List<Survey> surveysNew = targetDao.queryBuilder().where(SurveyDao.Properties.Organization_id.eq(Session.getInstance().getOrganizationId())).orderAsc(SurveyDao.Properties.Title).list();
            synchronized (this) {
                if (mSortedSurveys == null) {
