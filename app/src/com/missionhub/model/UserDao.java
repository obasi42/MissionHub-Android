...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Primary_organization_id = new Property(2, Long.class, "primary_organization_id", false, "PRIMARY_ORGANIZATION_ID");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'USER' (" + //
                ...
                "'PRIMARY_ORGANIZATION_ID' INTEGER," + // 2: primary_organization_id
    ...
    protected void bindValues(SQLiteStatement stmt, User entity) {
        ...
        Long primary_organization_id = entity.getPrimary_organization_id();
        if (primary_organization_id != null) {
            stmt.bindLong(3, primary_organization_id);
        }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2), // primary_organization_id
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setPrimary_organization_id(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
