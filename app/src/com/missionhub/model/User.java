 ...
 */
public class User implements com.missionhub.model.TimestampedEntity {
    ...
    public User(Long id, Long person_id, Long primary_organization_id, String updated_at, String created_at) {
        this.id = id;
