...
public class Rejoicable {
    ...
    public FollowupComment getFollowupComment() {
        Long __key = this.followup_comment_id;
        if (followupComment__resolvedKey == null || !followupComment__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            FollowupCommentDao targetDao = daoSession.getFollowupCommentDao();
            FollowupComment followupCommentNew = targetDao.load(__key);
            synchronized (this) {
                followupComment = followupCommentNew;
            	followupComment__resolvedKey = __key;
            }
        }
