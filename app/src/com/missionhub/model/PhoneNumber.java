...
public class PhoneNumber {
    ...
    private java.util.Date email_updated_at;
    ...
    public PhoneNumber(Long id, String number, String location, Boolean primary, String txt_to_email, java.util.Date email_updated_at, Long person_id, java.util.Date updated_at, java.util.Date created_at) {
        this.id = id;
        this.number = number;
    ...
    public java.util.Date getEmail_updated_at() {
        return email_updated_at;
    }

    public void setEmail_updated_at(java.util.Date email_updated_at) {
        this.email_updated_at = email_updated_at;
    }
