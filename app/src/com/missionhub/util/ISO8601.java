 ...
 * ISO8601-compliant format (see <a href="http://www.w3.org/TR/NOTE-datetime">ISO 8601</a>).
 * <p/>
 * The currently supported format is:
 * <p/>
 * <pre>
 *   &plusmn;YYYY-MM-DDThh:mm:ssZD
 * </pre>
 * <p/>
 * where:
 * <p/>
...
public final class ISO8601 {
    ...
    public static Calendar parse(final String text) {
        ...
        /**
         * the expected format of the remainder of the string is: YYYY-MM-DDThh:mm:ssTZD
         *
     ...
     * @throws IllegalArgumentException if a <code>null</code> argument is passed or the calendar cannot be represented as defined by ISO
     ...
     * @throws IllegalArgumentException if calendar cannot be represented as defined by ISO 8601 (i.e. year with more than four digits).
     */
     ...
     */
    private static void appendZeroPaddedInt(final StringBuffer buf, int n, final int precision) {
        if (n < 0) {
            buf.append('-');
            n = -n;
        }
