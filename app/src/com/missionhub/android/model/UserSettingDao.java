...
public class UserSettingDao extends AbstractDao<UserSetting, Long> {
    ...
    */
    ...
    @Override
    protected void attachEntity(UserSetting entity) {
    ...
    protected UserSetting loadCurrentDeep(Cursor cursor, boolean lock) {
        UserSetting entity = loadCurrent(cursor, 0, lock);
    ...
    public UserSetting loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<UserSetting> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<UserSetting> list = new ArrayList<UserSetting>(count);
    ...
    protected List<UserSetting> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<UserSetting> queryDeep(String where, String... selectionArg) {
