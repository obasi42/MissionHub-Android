...
import com.missionhub.android.application.Application.OnLowMemoryEvent;
...
public class ObjectStore {
     ...
     * @param key
     * @param object
     * @param expires the number of milliseconds from current the object expires
     */
     ...
     * Generates the nanosecond time at which the object expired.
     *
     * @param millis the number of milliseconds from current.
     * @return the nanosecond time in the future
     */
